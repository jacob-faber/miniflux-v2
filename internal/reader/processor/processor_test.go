...
func TestBlockingEntries(t *testing.T) {
	var scenarios = []struct {
		...
		{&model.Feed{ID: 1, BlocklistRules: "(?i)example"}, &model.Entry{Title: "Something different", Author: "Something different", Content: "Example content"}, &model.User{}, true},
...
func TestAllowEntries(t *testing.T) {
	var scenarios = []struct {
		...
		{&model.Feed{ID: 1, KeeplistRules: "(?i)example"}, &model.Entry{Title: "Something different", Author: "Something different", Content: "Example content"}, &model.User{}, true},
